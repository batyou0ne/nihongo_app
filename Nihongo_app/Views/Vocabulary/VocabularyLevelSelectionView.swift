...
/// Kelime modülünün ilk ekranı: JLPT seviyesi seçimi (N5-N1). Şu an sadece N5 için
/// veri var (bkz. N5VocabularyData.json); diğer seviyeler veri eklenene kadar kilitli.
